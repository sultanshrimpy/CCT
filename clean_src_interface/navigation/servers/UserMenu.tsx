          ...
          >
            <ContextMenu>
                ...
                <Row align gap="sm">
                  ...
                  <div
                    use:floating={{
                      tooltip: {
                        placement: "top",
                        content: "Only mentions will notify you",
                      },
                    }}
                  >
                    <MdInfo {...iconSize(12)} />
                ...
                <Row align gap="sm">
                  ...
                  <div
                    use:floating={{
                      tooltip: {
                        placement: "top",
                        content: "You will not receive any notifications",
                      },
                    }}
                  >
              ...
              >
                ...
                <ContextMenuButton
                  icon={MdDelete} onClick={() => user()?.edit({ remove: ["StatusText"] })}
                >
                  Clear status
                </ContextMenuButton>
              </Show>
